<template>
  <PageHeaderLayout :has_back = "true">
    ...
    <div class="product-detail-container">
      ...
      <div v-if="totaldaNum" class="product-detail-title" v-text="productName">后视镜001</div>
      <div v-if="totaldaNum" class="product-detail-content">
        ...
        <div>
          <div>
            <div class="group-title">
              ...
              <div>报废率最<span class="font-color-red">低</span>组合</div>
            </div>
        ...
        <div>
          <div>
            <div class="group-title">
              ...
              <div>报废率最<span class="font-color-red">高</span>组合</div>
            </div>
        ...
        <div>
          <div>
            <div class="group-title" style="padding-top: 16px;height: 85px;">
              <div class="group-title-text" style="padding-bottom: 15px"><div v-text="minRejectRatioMoudle.cname">模具1</div></div>
              <div class="mould-title">报废率最<span class="font-color-red">低</span>模具</div>
            </div>
        ...
        <div>
          <div>
            <div class="group-title" style="padding-top: 16px;height: 85px;">
              <div class="group-title-text" style="padding-bottom: 15px"><div v-text="maxRejectRatioMoudle.cname">模具2</div></div>
              <div class="mould-title">报废率最<span class="font-color-red">高</span>模具</div>
            </div>
      ...
      <div style="padding-right: 5px">
        <div class="module-container">
          <div class="module-title">
            ...
            <el-button v-if="totaldaNum" class="view-all" size="mini" @click="viewAllMould">查看源数据<i class="el-icon-d-arrow-right el-icon--right"/></el-button>
          </div>
      ...
      <div style="padding-left: 5px">
        <div class="module-container">
          <div class="module-title">
            ...
            <el-button v-if="totaldaNum" class="view-all" size="mini" @click="viewAllEqpt">查看源数据<i class="el-icon-d-arrow-right el-icon--right"/></el-button>
          </div>
          <div class="module-content" style="height: 290px;">
            <div v-if="!totaldaNum" class="no-data">
              <svg-icon class="no-data-icon" icon-class="noData"/>
    ...
    <div class="module-container">
      <div class="module-title">
        ...
        <el-button v-if="totaldaNum" class="view-all" size="mini" @click="viewAllMouldEqpt">查看源数据<i class="el-icon-d-arrow-right el-icon--right"/></el-button>
      </div>
      <div class="module-content" style="height: 290px;">
        <div v-if="!totaldaNum" class="no-data">
          <svg-icon class="no-data-icon" icon-class="noData"/>
    ...
    <div class="module-container" style="margin-bottom: 0">
      <div class="module-title">
        ...
        <el-button v-if="totaldaNum" class="view-all" size="mini" @click="viewAllFrom">查看源数据<i class="el-icon-d-arrow-right el-icon--right"/></el-button>
      </div>
