  ...
  <PageHeaderLayout :has_back = "true">
        ...
        <div class="equipment-container">
          <div class="equipment-left-container">
            <div class="equipment-left-top-container">
              <div style="padding-right: 5px">
                <div class="module-box">
                  <div class="equipment-container-title">异常停机总次数</div>
                  <div class="equipment-container-icon-num">
                    <svg-icon class="icon" icon-class="shebei3"/>
              ...
              <div style="padding-left: 5px">
                <div class="module-box">
                  <div class="equipment-container-title">总停机时长</div>
                  <div class="equipment-container-icon-num">
                    <svg-icon class="icon" style="color: #e25d5d" icon-class="shebei3"/>
                    <span class="text"><span v-text="closeTimeTotal">3543</span> min</span>
                  </div>
                </div>
              </div>
            </div>
            <div class="module-bottom-box">
              ...
              <div>
                ...
                <div>
                  <div>累计加工总数</div>
                  <div class="font-weight-bold text-color-red"><span v-text="maxRejectEqptDaum">42</span> 次</div>
                </div>
                <div>
                  <div>报废率</div>
          ...
          <div class="equipment-right-container">
            <div class="module-bottom-box" style="margin-top: 0">
              ...
              <div>
                <div>
                  <div class="font-weight-bold" v-text="maxdownFaultReason">模具异常</div>
                </div>
                <div>
                  <div>累计停机次数</div>
            ...
            <div class="module-bottom-box">
              ...
              <div>
                ...
                <div>
                  <div>累计加工数量</div>
                  <div class="font-weight-bold text-color-red"><span v-text="minRejectEqptDanum">42</span> 次</div>
                </div>
                <div>
                  <div>报废率</div>
    ...
    <div class="module-container">
      <div class="module-title">
        ...
        <el-button v-if="equipmentList[0].descRejectList.length !== 0" class="view-all" size="mini" @click="viewAllEquipment">查看源数据<i class="el-icon-d-arrow-right el-icon--right"/></el-button>
      </div>
      <div class="module-content equipment-content">
        <div v-if="equipmentList[0].descRejectList.length === 0" class="no-data">
          <svg-icon class="no-data-icon" icon-class="noData"/>
          <div>暂无数据</div>
        </div>
        <div v-if="equipmentList[0].descRejectList.length !== 0">
    ...
    <div class="module-container">
      <div class="module-title">
        ...
        <el-button v-if="equipmentList[2].descRejectList.length !== 0" class="view-all" size="mini" @click="viewAllEquipment350">查看源数据<i class="el-icon-d-arrow-right el-icon--right"/></el-button>
      </div>
      <div class="module-content equipment-content">
        <div v-if="equipmentList[2].descRejectList.length === 0" class="no-data">
          <svg-icon class="no-data-icon" icon-class="noData"/>
          <div>暂无数据</div>
        </div>
        <div v-if="equipmentList[2].descRejectList.length !== 0">
    ...
    <div class="module-container">
      <div class="module-title">
        ...
        <el-button v-if="equipmentList[3].descRejectList.length !== 0" class="view-all" size="mini" @click="viewAllEquipment500">查看源数据<i class="el-icon-d-arrow-right el-icon--right"/></el-button>
      </div>
      <div class="module-content equipment-content">
        <div v-if="equipmentList[3].descRejectList.length === 0" class="no-data">
          <svg-icon class="no-data-icon" icon-class="noData"/>
          <div>暂无数据</div>
        </div>
        <div v-if="equipmentList[3].descRejectList.length !== 0">
      ...
      <div style="padding-right: 5px">
        <div class="module-container">
          <div class="module-title">
            ...
            <el-button v-if="equipmentList[1].descRejectList.length !== 0" class="view-all" size="mini" @click="viewAllEquipment250">查看源数据<i class="el-icon-d-arrow-right el-icon--right"/></el-button>
          </div>
          <div class="module-content equipment-content">
            <div v-if="equipmentList[1].descRejectList.length === 0" class="no-data">
              <svg-icon class="no-data-icon" icon-class="noData"/>
              <div>暂无数据</div>
            </div>
            <div v-if="equipmentList[1].descRejectList.length !== 0">
      ...
      <div style="padding-left: 5px">
        <div class="module-container">
          <div class="module-title">
            ...
            <el-button v-if="equipmentList[6].descRejectList.length !== 0" class="view-all" size="mini" @click="viewAllEquipment900">查看源数据<i class="el-icon-d-arrow-right el-icon--right"/></el-button>
          </div>
          <div class="module-content equipment-content">
            <div v-if="equipmentList[6].descRejectList.length === 0" class="no-data">
              <svg-icon class="no-data-icon" icon-class="noData"/>
              <div>暂无数据</div>
            </div>
            <div v-if="equipmentList[6].descRejectList.length !== 0">
      ...
      <div style="padding-right: 5px">
        <div class="module-container">
          <div class="module-title">
            ...
            <el-button v-if="equipmentList[4].descRejectList.length !== 0" class="view-all" size="mini" @click="viewAllEquipment650">查看源数据<i class="el-icon-d-arrow-right el-icon--right"/></el-button>
          </div>
          <div class="module-content equipment-content">
            <div v-if="equipmentList[4].descRejectList.length === 0" class="no-data">
              <svg-icon class="no-data-icon" icon-class="noData"/>
              <div>暂无数据</div>
            </div>
            <div v-if="equipmentList[4].descRejectList.length !== 0">
      ...
      <div style="padding-left: 5px">
        <div class="module-container">
          <div class="module-title">
            ...
            <el-button v-if="equipmentList[5].descRejectList.length !== 0" class="view-all" size="mini" @click="viewAllEquipment800">查看源数据<i class="el-icon-d-arrow-right el-icon--right"/></el-button>
          </div>
          <div class="module-content equipment-content">
            <div v-if="equipmentList[5].descRejectList.length === 0" class="no-data">
              <svg-icon class="no-data-icon" icon-class="noData"/>
              <div>暂无数据</div>
            </div>
            <div v-if="equipmentList[5].descRejectList.length !== 0">
