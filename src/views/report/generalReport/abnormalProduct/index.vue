  ...
  <PageHeaderLayout :has_back="true">
    <div class="module-container" style="margin-bottom: 0">
      ...
      <div class="module-content trend-content">
        ...
        <el-button style="margin-bottom: 15px" type="primary" icon="el-icon-search" size="medium" @click="fetchData">搜索</el-button>
        <div style="float: right;margin-top: 12px">
          时间范围：<span>2018.10.15</span> - <span>2.18.11.15</span>
        </div>
        <el-table
          ...
          <el-table-column label="压铸报废率" align="center" prop="yzrate">
            <template slot-scope="scope">
              {{ scope.row.yzrate }} %
            </template>
          </el-table-column>
          <el-table-column label="机加工报废率" align="center" prop="jjrate">
            <template slot-scope="scope">
              {{ scope.row.jjrate }} %
            </template>
          </el-table-column>
          <el-table-column label="氧化终检报废率" align="center" prop="yhrate">
            <template slot-scope="scope">
              {{ scope.row.yhrate }} %
            </template>
          </el-table-column>
