      ...
      <div class="cockpit-container-right">
        <div class="module-container classes">
          ...
          <div class="module-content">
            <chart id="classes" ref="classes" :options="classesOptions" height="160px" width="100%" />
          </div>
        </div>
        <div class="module-container">
          ...
          <div class="module-content staff-table" style="padding: 11px 15px 10px 15px">
            <el-table
      ...
      <div class="cockpit-container-left">
          ...
          <div class="module-container pandect">
            ...
            <div class="module-content" style="padding-left: 0px">
              <div class="pandect-text">
                <div><span class="number-title">生产总数：</span> <span style="font-size: 22px;color: #5268a5;font-weight: bold;vertical-align: middle" v-text="rejectInfoDaNum">2,123,46</span></div>
                ...
                <div><span class="number-title">环比增幅：</span><span :class="{'down':rejectInfo.t < 0}" class="ratio"><span v-text="rejectInfo.t">+0.2</span> %</span></div>
              </div>
              <div class="pandect-chart">
                <div style="font-size: 18px;color: #009494;font-weight: bold;">
                  <div style="width: 262px;margin: 0 auto">
                    <span style="vertical-align: middle">历史平均报废率：</span> <span style="font-size: 28px;color: #de525f;vertical-align: middle"><span v-text="rejectInfo.rejectRatio">7.5</span> %</span>
                  </div>
                </div>
          ...
          <div class="module-container constitute">
            ...
            <div class="module-content">
              <div v-if="reasonConstituteData.length === 0" class="no-data">
                <svg-icon class="no-data-icon" icon-class="noData" style="margin-top: 15px"/>
                <div>暂无数据</div>
              </div>
        ...
        <div class="module-container">
          <div class="module-title">
            ...
            <el-button :type="currentNum===2?'primary':''" class="view-all" style="margin-right: 10px" size="mini" @click="switchBtn(2)">后 20<i class="el-icon-arrow-right el-icon--right"/></el-button>
            <el-button :type="currentNum===1?'primary':''" class="view-all" icon="el-icon-arrow-left" size="mini" @click="switchBtn(1)">前 20</el-button>
          </div>
          <div class="module-content" style="padding-left: 10px">
            <chart id="product" ref="product" :options="productOptions" height="194px" width="100%" />
          </div>
        </div>
        <div class="module-container">
          <div class="module-title">
            <div class="module-title-text">压铸机报废率Top10</div>
            <el-button class="view-all" size="mini" @click="viewEquipmentAll">查看全部<i class="el-icon-d-arrow-right el-icon--right"/></el-button>
          </div>
          <div class="module-content" style="padding-left: 10px">
            <chart id="machine" ref="machine" :options="machineOptions" height="194px" width="100%" />
          </div>
        </div>
      </div>
    </div>
